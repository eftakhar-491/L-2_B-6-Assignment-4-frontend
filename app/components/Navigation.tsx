      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex h-16 items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8">
            <Link href="/meals" className="text-sm hover:text-primary transition-colors">
              Browse Meals
            </Link>
            ...
            {isAuthenticated && user?.role === 'provider' && (
              <>
                <Link href="/provider/dashboard" className="text-sm hover:text-primary transition-colors">
                  Dashboard
                </Link>
                <Link href="/provider/menu" className="text-sm hover:text-primary transition-colors">
                  Menu
                </Link>
              </>
            )}
        ...
        {mobileMenuOpen && (
          <div className="md:hidden pb-4 space-y-2">
            <Link href="/meals" className="block px-4 py-2 hover:bg-secondary rounded-md">
              Browse Meals
            </Link>
            {isAuthenticated && user?.role === 'customer' && (
              <>
                <Link href="/orders" className="block px-4 py-2 hover:bg-secondary rounded-md">
                  Orders
                </Link>
                <Link href="/profile" className="block px-4 py-2 hover:bg-secondary rounded-md">
                  Profile
                </Link>
              </>
            )}
